...
export const body = (district, commType) =>
  encodeURIComponent(`Good day Sir/Ma,

My name is ____, a concerned constituent from ${district}. I write this ${commType} to strongly condemn The Anti-Social Media Bill (hereinafter "the bill") currently in the committee stage at the Red chambers and to implore you to vote against this bill.
